...
export default class Listjatim extends Component {
 constructor() {
  super();
 ...
 getVids() {
  this.setState({
   Vids: [ {
    ...
    'url' : 'https://www.youtube.com/embed/QGXA4B8zlHM?rel=0&autoplay=0&showinfo=0&controls=1'
   },
   {
    'Title' : 'Rek Ayo Rek',
    'url' : 'https://www.youtube.com/embed/U0nbVNigEB8?rel=0&autoplay=0&showinfo=0&controls=1'
   } ],
   loading: false
  });
 }
      ...
      <Container>
          <StatusBar hidden={true} backgroundColor="#891845" />
                <Header style={{ backgroundColor: '#891845' }} >
                    ...
                    <Body>
                        <Title style={{color: 'white', paddingTop: 13 }} >Jawa Timur</Title>
                    </Body>
                    <Right>
                    </Right>
                </Header>
